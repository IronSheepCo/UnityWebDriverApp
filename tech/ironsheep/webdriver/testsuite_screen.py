...
class TestSuiteScreen(Screen):
    ...
    test_case_suite_view = ObjectProperty(None)
    test_case_suite_stack = ObjectProperty(None)

    def on_enter(self):
        self.title_label.text = "connected to "+Config.server_ip
        self.test_case_suite_stack.bind(minimum_height=self.test_case_suite_stack.setter('height') )
        self.test_case_suite_view.my_screen = self

    def Back(self):
        self.test_case_suite_view.show_test_case()
